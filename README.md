...
Este repositório reúne uma série de atividades práticas desenvolvidas em PHP e HTML, com foco no aprendizado de lógica de programação e desenvolvimento web básico.

## Conteúdo abordado

As atividades incluem:

* Estruturas básicas de HTML e formulários
* Manipulação de dados com PHP (`$_POST`)
